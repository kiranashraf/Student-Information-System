...
<p>&nbsp;</p></div>
<form id="form1" name="form1" method="get" action="delete2.php">
  <div align="right"> </div>
      ...
      <tr> 
        <td width="325" height="32" align="left"> 
          <div align="center"><tt><font color="#FFFFFF"><font face="Georgia, Times New Roman, Times, serif" size="4">Enter 
             record's Roll no. to be deleted</font></font></tt></div>
        </td>
        <td width="219" height="32"> 
          <div align="center"><tt><label> 
            <input type="text" name="rollno" id="textfield" onBlur="MM_validateForm('textfield','','R');return document.MM_returnValue">
            </label></tt></div>
        </td>
      </tr>
      <tr> 
