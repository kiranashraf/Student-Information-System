...
<form id="form1" name="form1" method="get" action="insert2.php">
  <table align="center" width="291" border="0">
    ...
    <td> 
        <input type="text" name="fname" id="textfield2" onBlur="MM_validateForm('textfield','','R','textfield2','','R','textfield3','','R','textfield4','','R','textfield5','','R','textfield6','','R','textfield7','','R','textfield8','','R');return document.MM_returnValue" />
    </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="reg" id="textfield4" onBlur="MM_validateForm('textfield','','R');return document.MM_returnValue" />
      </td>
    </tr>
    <tr> 
      <td><font color="#FFFFFF"><strong>Department Name</strong>:</font></td>
      <td> 
        <input type="text" name="dept" id="textfield5" />
      </td>
    </tr>
    <td><font color="#FFFFFF"><strong>Section</strong>:</font></td>
    <td> 
      <input type="text" name="sec" id="textfield6" />
    </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="addr" id="textfield8" />
      </td>
    </tr>
      </table>
