      ...
      <td>
        <div align="center">
          ...
          <h2><font color="#FFFFFF"><u><font face="Arial, Helvetica, sans-serif"><font size="5"><a href="faculty.htm"><font color="#333333"><b><font color="#FFFFFF">Faculty 
            ...
            <font color="#333333"><b>=&gt;</b> </font></font></font><font color="#333333"><u><font face="Arial, Helvetica, sans-serif"><font size="5"><a href="Insert.htm"><font color="#003333"><b>Insert</b></font></a></font></font></u></font></font></h2>
        </div>
      </td>
    </tr>
  </table>
...
<form id="form1" name="form1" method="get" action="insertf2.php">
  <table align="center" width="291" border="0">
    <tr> 
      <td width="129" height="32"><font color="#FFFFFF"><strong>Name:</strong></font></td>
      <td width="152" height="32"><label> 
        <input type="text" name="name" id="textfield" value="">
        </label></td>
    </tr>
    <td><font color="#FFFFFF"><strong>Designation:</strong>:</font></td>
    <td> 
        <input type="text" name="desig" id="textfield2" onBlur="MM_validateForm('textfield','','R','textfield2','','R','textfield3','','R','textfield4','','R','textfield5','','R','textfield6','','R','textfield7','','R','textfield8','','R');return document.MM_returnValue" />
    </td>
    </tr>
    <tr> 
      <td><font color="#FFFFFF"><strong>Qualification:</strong></font></td>
      <td> 
        <input type="text" name="qual" id="textfield3" />
      </td>
    </tr>
      ...
      <td> 
        <input type="text" name="contact" id="textfield4" />
      </td>
    </tr>
    <tr> 
      <td><font color="#FFFFFF"><b>Address:</b></font></td>
      <td> 
        <input type="text" name="addr" id="textfield5" />
      </td>
    </tr>
      </table>
