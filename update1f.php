...
<p>&nbsp;</p></div>
<form id="form1" name="form1" method="get" action="update2f.php">
  <div align="right"> </div>
      ...
      <tr> 
        <td width="287" height="32" align="left"> 
          <div align="center"><tt><font color="#FFFFFF"><font face="Georgia, Times New Roman, Times, serif" size="4">Enter 
            record's name to be Updated</font></font></tt></div>
        </td>
        <td width="257" height="32"> 
          <div align="center"><tt><label> 
            <input type="text" name="uname" id="textfield" onBlur="MM_validateForm('textfield','','R');return document.MM_returnValue">
            </label></tt></div>
        </td>
      </tr>
      <tr> 
