...
<p>&nbsp;</p>
 ...
 <p align="center">
    <?php 
	 ...
	 $query="SELECT * FROM faculty WHERE `sname` LIKE CONVERT( _utf8 '$name' USING latin1 )";
...
<form id="form1" name="form1" method="get" action="update3f.php">
  <table align="center" width="291" border="0">
    ...
    <td> 
        <input type="text" name="desig" id="textfield2" value="<?php echo $result[2] ?>" onBlur="MM_validateForm('textfield','','R','textfield2','','R','textfield3','','R','textfield4','','R','textfield5','','R','textfield6','','R','textfield7','','R','textfield8','','R');return document.MM_returnValue" />
    </td>
    </tr>
    <tr> 
      <td><font color="#FFFFFF"><strong>Qualification:</strong></font></td>
      <td> 
        <input type="text" name="qual" id="textfield3" value="<?php echo $result[3] ?>" />
      </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="contact" id="textfield4" value="<?php echo $result[4] ?>"  />
      </td>
    </tr>
    <tr> 
      <td><font color="#FFFFFF"><b>Address:</b></font></td>
      <td> 
        <input type="text" name="addr" id="textfield5" value="<?php echo $result[5] ?>"  />
      </td>
    </tr>
      </table>
